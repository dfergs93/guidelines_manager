...
Previously, a backend server was being used to generate a chatbot for the site, but this has been removed and is out of scope for this project. There are multiple clinical guidlines in clinical_guidelines_database/ which needs to be culled to the most important ones.
